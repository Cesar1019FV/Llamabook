    ...
    <div className="quick-actions flex flex-wrap gap-1.5 mb-6">
      {actions.map((action) => {
        ...
        return (
          <button
            key={action.id}
            className="q-action flex items-center gap-[5px] py-[7px] px-3.5 rounded-2xl border border-llama-border text-llama-fg-3 text-[12.5px] font-normal whitespace-nowrap transition-all duration-150 hover:border-llama-border-2 hover:text-llama-fg-2 hover:bg-white/[0.02]"
