  ...
  return (
    <div className="flex items-center justify-between pt-3.5 pb-1.5 px-3 shrink-0">
      <div className="text-[15px] font-semibold text-llama-fg tracking-tight px-1">
        {t('dashboard.brand')}
        <span className="font-light text-llama-fg-4">AI</span>
      </div>
      <div className="flex gap-0.5">
        <button
          className="sb-btn w-[30px] h-[30px] flex items-center justify-center rounded-md text-llama-fg-3 transition-colors duration-150 hover:bg-llama-sidebar-hover hover:text-llama-fg"
          onClick={() => {
            toggleSidebar()
            closeMobileSidebar()
          }}
