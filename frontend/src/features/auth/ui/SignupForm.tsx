  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="signup-name" className="text-xs text-llama-fg-4 font-medium">
          {t('auth.signup.name')}
        </label>
        <input
          id="signup-name"
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="signup-email" className="text-xs text-llama-fg-4 font-medium">
          {t('auth.signup.email')}
        </label>
        <input
          id="signup-email"
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="signup-password" className="text-xs text-llama-fg-4 font-medium">
      ...
      <p className="text-center text-xs text-llama-fg-4">
        ...
        <a href="/login" className="text-llama-accent hover:text-llama-accent-light">
